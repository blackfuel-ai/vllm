...
def _cp_gather_indexer_quant_cache_kernel(
    ...
    val = tl.load(src_cache_ptr + tiled_src_offset, mask=valid_block)
...
def rocm_aiter_sparse_attn_indexer(
    ...
    if has_decode:
        ...
        if candidate_blocks is not None and _DSA_CANDIDATE_SELECTION:
            ...
            # otherwise, matching the bound the row top-k below applies.
            vis = decode_metadata.seq_lens[:batch_size].reshape(-1)
